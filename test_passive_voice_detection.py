...
def import_passive_voice_module():
    ...
    spec = importlib.util.spec_from_file_location("passive_voice_detection", module_path)
...
def test_basic_functionality():
    ...
    test_cases = [
        ...
        ("The politics being discussed were causing a scene.", True),  # Tricky case from our tests
    ]
...
def test_api_availability():
    ...
    try:
        ...
        if result:
            ...
            voice_type = "passive" if fragments else "active"
            print(f"✅ API connection successful! Test sentence classified as: {voice_type}")
        else:
