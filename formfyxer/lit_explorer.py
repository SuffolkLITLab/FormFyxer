...
included_fields = load(os.path.join(os.path.dirname(__file__), 'formfyxer/data', 'included_fields.joblib'))
jurisdictions = load(os.path.join(os.path.dirname(__file__), 'formfyxer/data', 'jurisdictions.joblib'))
groups = load(os.path.join(os.path.dirname(__file__), 'formfyxer/data', 'groups.joblib'))
clf_field_names = load(os.path.join(os.path.dirname(__file__), 'formfyxer/data', 'clf_field_names.joblib'))
